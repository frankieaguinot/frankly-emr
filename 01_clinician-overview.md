...
Frankly EMR’s interface is powered by a built-in AI, but not the kind that just throws out random suggestions.
...
Frankly EMR is built to feel familiar from day one.  
...
Frankly EMR was built to give you time back, to bring the focus back to care, not clicks.
